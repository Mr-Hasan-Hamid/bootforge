      ...
      <main className="mx-auto max-w-4xl px-6 pb-24 space-y-8 relative z-10">
        ...
        <section className="glass-panel border border-neutral-200 dark:border-neutral-900 bg-white/70 dark:bg-neutral-950/70 p-6 md:p-8 rounded-2xl space-y-4 shadow-sm">
          ...
          <div className="text-xs text-neutral-600 dark:text-neutral-400 space-y-3 leading-relaxed">
            <p>
              BootAnimDeck is an open-source, non-commercial directory and customization studio. The boot animations indexed on this platform are a **community-curated collection** gathered from publicly available internet sources, including developer forums (e.g. XDA Developers), public Telegram groups, and customization platforms.
            </p>
            <p>
              We do **not** claim ownership or copyright of any pre-existing boot animation assets indexed in the gallery. All intellectual property, trademarks, and copyrights belong entirely to their respective original designers, developers, or parent brands.
            </p>
            <p className="font-semibold text-neutral-850 dark:text-neutral-200">
              Requesting a Removal (Takedown Protocol):
            </p>
            <p>
              If you are the original artist, designer, or copyright owner of any boot animation hosted/indexed here and wish to have it removed from our listing, please contact us directly at <a href="mailto:hasanhamid750@gmail.com" className="text-cyan-600 dark:text-cyan-400 hover:underline">hasanhamid750@gmail.com</a>. We respect the intellectual property of creators and will process removal requests immediately within 24-48 hours, no formal legal warnings required.
            </p>
          </div>
        </section>
        ...
        <section className="glass-panel border border-neutral-200 dark:border-neutral-900 bg-white/70 dark:bg-neutral-950/70 p-6 md:p-8 rounded-2xl space-y-4 shadow-sm">
          ...
          <div className="text-xs text-neutral-600 dark:text-neutral-400 space-y-3 leading-relaxed">
            ...
            <p className="font-mono text-neutral-800 dark:text-neutral-300 bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-850 p-3 rounded-lg text-[10px]">
            ...
            <p>
              You are modifying your device at your own risk. BootAnimDeck, its contributors, and developers are not responsible for soft-bricks, bootloops, hardware damage, lost data, or system instabilities on your device. Always keep custom recovery access ready and keep backups of stock system partition assets.
            </p>
          </div>
        </section>
        ...
        <section className="glass-panel border border-neutral-200 dark:border-neutral-900 bg-white/70 dark:bg-neutral-950/70 p-6 md:p-8 rounded-2xl space-y-4 shadow-sm">
          ...
          <div className="text-xs text-neutral-600 dark:text-neutral-400 space-y-3 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-1.5 pl-2 font-mono text-[10px]">
              <li>**No Server Storage**: All file parsing, `desc.txt` configuration editing, and custom archive generation run 100% inside your browser client-side.</li>
              <li>**No User Tracking**: We do not collect, process, or transmit personal data or uploaded animations/videos to external servers.</li>
              <li>**Zero Logs**: We run no telemetry trackers or diagnostic log databases that compromise user session details.</li>
            </ul>
          </div>
        </section>
